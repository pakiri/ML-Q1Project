...
# Modification of classifiers.py just for the SVC model with correlation feature selection

output = "Q1 Project/models/svc_correlation.pkl"
selections = ("correlation",)
...
def main():
    ...
    if not os.path.exists('Q1 Project/models'):

        os.makedirs('Q1 Project/models')
